function [Theta,err,i,time]=A_Naive_NMD(X,r,param)
...
% and a TSVD to update Theta=TSVD(Z,r). We then perform a momentum step on
% Z in order to accelerate the convergence. 
%     
...
%       .alpha1 = momentum parameter (default: 0.7)
...
for i=1:param.maxit
    ...
    %Momentum step
    Z=Z+param.alpha1*(Z_old-Z_old_old);
